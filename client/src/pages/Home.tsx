...
export default function Home() {
  ...
  return (
    <div className="w-full">
      ...
      {/* 2. BRAND INTRO */}
      <section className="bg-paper pt-16 sm:pt-20 md:pt-24 pb-14 sm:pb-20 md:pb-24 reveal">
      ...
      {/* 4. WHY BERCO */}
      <section className="bg-paper pt-18 sm:pt-20 md:pt-24 pb-14 sm:pb-20 md:pb-24 reveal">
        <div className="max-w-content mx-auto px-4 sm:px-6 md:px-8">
