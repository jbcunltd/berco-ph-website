      ...
      <div className="max-w-content mx-auto px-6 md:px-8 py-16 md:py-20">
        <div className="grid md:grid-cols-12 gap-10 mb-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="mt-4 text-light/70 max-w-sm text-[14px] leading-relaxed">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-[14px] leading-relaxed text-light/85">
              14 Jupiter Street<br />
              Bel-Air, Makati 1209<br />
              By appointment
            </p>
            <p className="mt-6 text-[14px] leading-relaxed text-light/85">
              +63 917 555 0114<br />
              hello@bercoph.com
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-2 text-[14px] text-light/85">
              <li>Metro Manila</li>
